...
export const choreographyPalette = {
  ...
  chrome: '#0F0F16',
  surface: '#101018',
  surfaceElevated: '#171726',
  chromeElevated: '#171726',
  // Softer hairlines (Procreate-like; less "boxy")
  ...
  surface3: '#1A1A28',
  // More "glassy" dock; less opaque slab
  dockBg: 'rgba(8, 8, 14, 0.82)',
  ...
  // Glass panels (lighter + less "square")
  surfaceGlass: 'rgba(12, 12, 20, 0.62)',
  surfaceGlassDark: 'rgba(8, 8, 14, 0.78)',
