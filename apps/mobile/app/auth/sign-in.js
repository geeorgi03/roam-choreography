    ...
    if (configError || !supabase) {
        ...
        <react_native_1.View style={styles.content}>
          ...
          <react_native_1.TouchableOpacity style={styles.link} onPress={() => expo_router_1.router.push('/auth/sign-up')}>
            <react_native_1.Text style={styles.linkText}>Create account</react_native_1.Text>
      ...
      <react_native_1.View style={styles.content}>
        ...
        <react_native_1.View style={styles.form}>
          ...
          <react_native_1.TouchableOpacity style={[styles.button, loading && styles.buttonDisabled]} onPress={handleSignIn} disabled={loading || !supabase}>
            <react_native_1.Text style={styles.buttonText}>{loading ? 'Signing in…' : 'Sign In'}</react_native_1.Text>
          </react_native_1.TouchableOpacity>
          <react_native_1.TouchableOpacity style={styles.link} onPress={() => expo_router_1.router.push('/auth/sign-up')}>
            <react_native_1.Text style={styles.linkText}>Don't have an account? Sign up</react_native_1.Text>
          </react_native_1.TouchableOpacity>
        </react_native_1.View>
